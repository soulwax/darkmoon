...
export class ColliderComponent extends Component {
    ...
    isTrigger: boolean;
    isStatic: boolean;
    onCollision: ((other: ColliderComponent) => void) | null;
    onTriggerEnter: ((other: ColliderComponent) => void) | null;
    onTriggerExit: ((other: ColliderComponent) => void) | null;
    overlapping: Set<ColliderComponent>;
    ...
    getCenter() {
        return {
            x: (this.entity?.x || 0) + this.offsetX,
            y: (this.entity?.y || 0) + this.offsetY
        };
    }
     ...
     * @returns {boolean}
     */
    intersects(other: ColliderComponent) {
        // Check layer masks
     ...
     */
    _circleBoxIntersect(colliderA: ColliderComponent, colliderB: ColliderComponent) {
     ...
     */
    getOverlap(other: ColliderComponent) {
