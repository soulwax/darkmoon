...
export class InputManager {
    ...
    constructor(config: { keyboard?: Record<string, string | string[]> } = {}) {
        // Key states
     ...
     */
    _setupDefaultBindings(keyboardConfig: Record<string, string | string[]>) {
        const defaults = {
            moveUp: 'KeyW',
            moveDown: 'KeyS',
            moveLeft: 'KeyA',
     ...
     */
    bind(action: string, keys: string | string[]) {
    ...
    _setupEventListeners() {
        ...
        this._handlers.contextmenu = (e: MouseEvent) => {
            e.preventDefault();
        };
     ...
     */
    _updateMousePosition(e: MouseEvent) {
        if (this.canvas) {
